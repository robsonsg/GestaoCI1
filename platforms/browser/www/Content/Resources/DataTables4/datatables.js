 ...
 *   https://datatables.net/download/#dt/jq-3.2.1/dt-1.10.16/b-1.5.1/b-colvis-1.5.1/cr-1.4.1/fc-3.2.4/fh-3.1.3/kt-2.3.2/r-2.2.1/rg-1.0.2/rr-1.2.3/sc-1.4.4
 *
 * Included libraries:
 *   jQuery 3 3.2.1, DataTables 1.10.16, Buttons 1.5.1, Column visibility 1.5.1, ColReorder 1.4.1, FixedColumns 3.2.4, FixedHeader 3.1.3, KeyTable 2.3.2, Responsive 2.2.1, RowGroup 1.0.2, RowReorder 1.2.3, Scroller 1.4.4
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/jq-3.2.1/dt-1.10.16/b-1.5.1/b-colvis-1.5.1/cr-1.4.1/fc-3.2.4/fh-3.1.3/kt-2.3.2/r-2.2.1/rg-1.0.2/rr-1.2.3/sc-1.4.4",
...
var _filename = function ( config )
{
	...
	var extension = _strOrFunction( config.extension );
	if ( ! extension ) {
		extension = '';
	}
 ...
 */
var _strOrFunction = function ( option )
{
...
{
	var title = _strOrFunction( config.title );
...
{
	var message = _strOrFunction( option );
	if ( message === null ) {
		return null;
	}
